    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/cats" element={<><Nav firstNav="Add Cat" firstNavClass="btn btn-primary" /><AddCat /><Cats /></>} />
          <Route path="/header-cats" element={<><Nav firstNav="Add Cat" firstNavClass="btn btn-primary" /><AddHeaderCat /><EditHeaderCat /><HeaderCat /></>} />
          <Route path="/admin-product" element={<><Nav firstNav="Add Product" firstNavClass="btn btn-primary" /><AddProduct /><EditProduct /><AdminProduct /></>} />
